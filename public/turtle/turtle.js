...
imageContext.canvas.width  = window.innerWidth;
imageContext.canvas.height = window.innerHeight;
...
turtleContext.canvas.width  = window.innerWidth;
turtleContext.canvas.height = window.innerHeight;
...
function draw() {
    ...
    turtleContext.drawImage(imageCanvas, 0, 0, turtleContext.canvas.width, turtleContext.canvas.height, 0, 0, turtleContext.canvas.width, turtleContext.canvas.height);
}
